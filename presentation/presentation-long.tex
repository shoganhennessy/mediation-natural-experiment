...
\begin{frame}
    ...
    $\to$ Medicaid is the government programme which provides health insurance for those close to the poverty line.
    \vskip-0.5cm
    \begin{figure}
        \centering
        \singlespacing
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item This gives \textbf{suggestive evidence for \textcolor{ForestGreen}{healthcare} as mediating mechanism}.
    \end{itemize}
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}
    ...
    \vskip-0.125cm
    \pause
    Explain direct EFFECTS HERE.  STRESS.  PSYCH GAINS.

    HOW LARGE THESE DIRECT EFFECTS ARE (AND SMALL/LARGE ETC) AFFECT HOW MUCH HEALTHCARE OPERATES THIS EFFECT.
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}
    \frametitle{Oregon: Suggestive Evidence}
    ...
    \begin{itemize}
        ...
        \item This gives \textbf{suggestive evidence for healthcare as mediating mechanism}.
    \end{itemize}
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}
