...
\begin{frame}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \node[color=red] [below=0.7cm of mediator] {+5.9pp (0.9) \textcolor{black}{and} +5.4pp (0.9)};
        \end{tikzpicture}
    \end{figure}
    \vskip-0.25cm
    ...
    \begin{itemize}
        ...
        \item Does \textcolor{ForestGreen}{visiting healthcare} at least once increase self-reported \textcolor{red}{health \& happiness} 12 months later?
        \item OLS is \textcolor{ForestGreen}{-1.9pp (1.0)} and \textcolor{ForestGreen}{+3.3 (1.1)} for health \& happiness, respectively.
    \end{itemize}
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}
...
\begin{frame}
    ...
    \par\noindent\rule{\textwidth}{0.4pt}
    \pause
    My approach to \textbf{CM} is modelling selection-into-$\textcolor{ForestGreen}{D_i}$ via mediator MTE:
    \begin{itemize}
        \item Uses an estimate of $\textcolor{ForestGreen}{D_i} \to \textcolor{red}{Y_i}$ (plus complier extrapolation)
        \item Regular healthcare location pre-lottery serves as an excluded IV \hyperlink{ohie-iv}{\beamergotobutton{IV}}.
        \item IV estimate of $\textcolor{ForestGreen}{D_i} \to \textcolor{red}{Y_i}$ is \textcolor{ForestGreen}{+34.2pp (4.4)} and \textcolor{ForestGreen}{+47.2pp (4.5)} for health \& happiness, respectively.
    \end{itemize}
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}
