...
\begin{frame}[noframenumbering]
    ...
    \begin{itemize}
        ...
        \hfill Education, socio-genetics, \\ \hfill observational causal inference
        \item Committee:
        \hfill Douglas Miller, Zhuan Pei, Evan Riehl
        \item Job interests:
        \hfill Research (university, post-doc, etc.)
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item OLS is \textcolor{ForestGreen}{$\approx 0$} (not significant).
    \end{itemize}
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}
...
\begin{frame}[noframenumbering]
    ...
    \end{figure}
    Structural estimate of mediator compliers' $\textcolor{ForestGreen}{D_i} \to \textcolor{red}{Y_i}$ is \textcolor{ForestGreen}{+34.2pp (4.4)}.
\end{frame}
%-------------------------------------------------------------------------------
\end{document}
