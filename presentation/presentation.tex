...
\begin{frame}[noframenumbering]
    ...
    \begin{enumerate}
        ...
        \begin{figure}
            ...
            \vspace{-0.5cm}
            \begin{tikzpicture}
                \node[state,blue] (treatment) at (0,0) {$Z$};
                \node[state,red] (outcome) [right=3.75cm of treatment] {$Y$};
        ...
        \begin{figure}
            ...
            \vspace{-0.5cm}
            \begin{tikzpicture}
                \node[state,ForestGreen] (mediator) at (0,0) {$D$};
                \node[state,blue] (treatment) [left=1.5cm of mediator] {$Z$};
                \node[state,red] (outcome) [right=1.5cm of mediator] {$Y$};
                ...
                \path[->, very thick, color=ForestGreen] (treatment) edge (mediator);
                \path[->, very thick, color=ForestGreen] (mediator) edge (outcome);
                \path[->, very thick, color=blue] (treatment) edge[bend right=45] (outcome);
    ...
    \begin{enumerate}
        ...
        \begin{figure}[h!]
            ...
            \begin{subfigure}[c]{0.55\textwidth}
                \begin{tikzpicture}
                    \node[state,ForestGreen] (mediator) at (0,0) {$D$};
                    \node[state,blue] (treatment) [left=1.25cm of mediator] {$Z$};
                    \node[state,red] (outcome) [right=1.25cm of mediator] {$Y$};
                    %\path[->,thick] (treatment) edge (mediator);
                    %\path[->,thick] (mediator) edge (outcome);
                    % Label the nodes with econ examples
                    ...
                    \path[->, very thick, color=ForestGreen] (treatment) edge (mediator);
                    \path[->, very thick, color=ForestGreen] (mediator) edge (outcome);
                    \path[->, very thick, color=blue] (treatment) edge[bend right=35] (outcome);
...
\begin{frame}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            \node[state,ForestGreen] (mediator) at (0,0) {$D$};
            \node[state,blue] (treatment) [left=2cm of mediator] {$Z$};
            \node[state,red] (outcome) [right=2cm of mediator] {$Y$};
            % Label Z, D, Y
            ...
            %\node[state,dashed,RoyalBlue] (confounderU) [above=0.75cm of outcome] {$\vec U$};
