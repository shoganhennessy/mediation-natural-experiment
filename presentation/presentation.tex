...
\begin{frame}[noframenumbering]
    ...
    \begin{itemize}
        \item Oregon wait-list lottery for \textcolor{blue}{health insurance} (Finkelstein et al, 2012).
    \end{itemize}
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}[noframenumbering]
...
\begin{frame}[noframenumbering]
    ...
    \begin{itemize}
        \item Did socialised health insurance increase hospital use, and improve health? (Finkelstein et al, 2012).
    \end{itemize}
    \pause
...
\begin{frame}[noframenumbering]
    \frametitle{Direct \& Indirect Effects --- Selection} 
    Oregon health insurance experiment (Finkelstein$+$ 2012).
    \vspace{-0.4cm}
    ...
    \text{ for } z', d' = 0, 1. \]
    \begin{enumerate}
        \item Medicaid assigned randomly (ensured by studying the 2008 Oregon wait-list lottery).
        \item \colorbox{yellow}{Healthcare usage is quasi-random, conditional on Medicaid assignment $Z_i$} \\
...
\end{frame}
%-------------------------------------------------------------------------------
\section{2. Identification with a Control Function}
%-------------------------------------------------------------------------------
\begin{frame}
