...
\begin{frame}
    ...
    and continuous outcome $Y_i$ for individuals $i = 1, \hdots, N$.
    \vskip-0.5cm
    \begin{figure}
        \centering
        \singlespacing
...
\begin{frame}[noframenumbering]
    ...
    \begin{itemize}
        \item Were drafted men poorer?  Did they conform or dodge?
        (Angrist, 1990).
    ...
    \begin{itemize}
        ...
        Were there gains from reduced uncertainty (risk averse insurance)?
        (Finkelstein+, 2009).
    \end{itemize}
\end{frame}%-------------------------------------------------------------------------------
\begin{frame}[noframenumbering]
