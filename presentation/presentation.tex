...
\begin{frame}
    ...
    Re-introduce the OHIE, with the SCM.

    Label it with the effect sizes.

    Show the correlational CM estimates, where $D_i \to Y_i$ is thought to be zero.
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}
    \frametitle{3. Returning to Oregon}
...
\begin{frame}
    \frametitle{3. Returning to Oregon}
    Show the $D_i \to Y_i$ effect estimate is now non-zero, and restore the CM estimates by my method.
\end{frame}
%-------------------------------------------------------------------------------
\section{Conclusion}
%-------------------------------------------------------------------------------
