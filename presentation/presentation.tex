...
\begin{frame}[noframenumbering]
    ...
    Identify second-stage via MTE control function (CF).
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}
...
\begin{frame}
    ...
    \begin{enumerate}
        ...
        \item \hl{Estimate second-stage separately for $D_i = 0$ and $D_i = 1$, with regressors $\lambda_0(p'), \lambda_1(p')$,} semi-parametric in $p' = \hat\pi(Z_i; \vec X_i)$.
        \item Compose CM estimates from two-stage plug-in estimates. 
    \end{enumerate}
    \vfill
...
\begin{frame}
    ...
    \begin{enumerate}
        \item Alternative to practice of ``suggestive evidence of mechanisms.''
