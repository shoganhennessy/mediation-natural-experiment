...
\begin{frame}
    ...
    \end{figure}
    \begin{itemize}
        \item Additional research studying education polygenic index, and mediation of its causal effect through education.
    \end{itemize}
\end{frame}
%-------------------------------------------------------------------------------
...
\begin{frame}
    ...
    \end{enumerate}
    \colorbox{yellow}{Translation: Healthcare is a quasi-random choice, conditional on wait-list lottery} \\\colorbox{yellow}{realisation and demographic controls.}
    \par\noindent\rule{\textwidth}{0.4pt}
