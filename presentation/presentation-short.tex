...
\begin{frame}
    \frametitle{About Me}
    I am an economics PhD student at Cornell University, with research interests in labour economics and applied econometrics.
    \begin{figure}
        \vskip-0.5cm
        \centering
        \singlespacing
        \includegraphics[width=0.65\textwidth]{
            ../../shoganhennessy.github.io/images/presentation-2024.jpg
        }
    \end{figure}
    \begin{itemize}
        \item Other applied research studying education polygenic index, and mediation of its causal effect through education.
    \end{itemize}
\end{frame}
%-------------------------------------------------------------------------------
...
\begin{frame}
    ...
    \textbf{This paper:}
    \begin{enumerate}
        \item Develop selection bias concept for CM in observational settings, with reasoning bias can crowd out inference
        \item Build an MTE--based model to tackle the identification problem
...
\begin{frame}
    \frametitle{Oregon Health Insurance Experiment}
    Winning this wait-list lottery significantly increased healthcare usage, plus subjective well-being (Finkelstein et al, 2012).
    \vskip-0.25cm
    \begin{figure}
        \centering
        \singlespacing
        \includegraphics[width=0.8\textwidth]{
            ../text/sections/figures/insurance-effects-presentation.png}
    \end{figure}
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \node[color=red,align=left] [right=0.1cm of outcome] {Subjective \\  well-being};
            ...
            \pause
            \node[color=red] [below=0.7cm of mediator] {+8pp};
...
\begin{frame}[noframenumbering]
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \node[color=black] (secondstage) at ($(mediator)!0.5!(outcome)$) {.};
            \node[color=orange] [above=-0.65cm of secondstage, align=center] {Healthcare \\effect};
        \end{tikzpicture}
    \end{figure}

    \par\noindent\rule{\textwidth}{0.4pt}
    CM decomposes the ATE into two channels, direct and indirect effects
    \[ \textcolor{orange}{\text{ATE}}
    = \textcolor{blue}{\text{ADE}} + \textcolor{ForestGreen}{\text{AIE}}. \]
\end{frame}
%-------------------------------------------------------------------------------
...
\begin{frame}
    \frametitle{Causal Mediation (CM)}
    Identification of the ADE $+$ AIE needs further assumptions.
    \par\noindent\rule{\textwidth}{0.4pt}
    \vskip-0.5cm
    \begin{figure}
        \centering
    ...
    \begin{enumerate}
        ...
        \item \textcolor{ForestGreen}{Mediator $D_i$} is (quasi-)randomly assigned, conditional on \textcolor{blue}{$Z_i$} realisation and controls $\vec X_i$.
    \end{enumerate}
    \vskip0.25cm
    $\implies$ ADE + AIE are separately identified by
    two-stage regression (Imai Keele Yamamoto 2010).
\end{frame}%-------------------------------------------------------------------------------
\begin{frame}
    \frametitle{Causal Mediation (CM)}
    ...
    \end{enumerate}
    \colorbox{yellow}{\textbf{Translation:} Healthcare is a quasi-random choice, conditional on wait-list} \\\colorbox{yellow}{lottery realisation and demographic controls.}
    \par\noindent\rule{\textwidth}{0.4pt}
...
\begin{frame}
    ...
    The \textcolor{blue}{wait-list lottery} has no strategic selection, but then \textcolor{ForestGreen}{visiting healthcare} is a choice.
    \par\noindent\rule{\textwidth}{0.4pt}
    \textbf{Theorem:}
    If choice to attend healthcare is based on costs and benefits (Roy model) and control variables do not explain all benefits $\implies$
...
\begin{frame}
    ...
    \makebox[\textwidth]{\parbox{1.25\textwidth}{
        \begin{figure}
            \vskip-0.25cm
            \caption{Simulated Distribution from 10,000 simulated datasets.}
            \vskip-0.25cm
...
\begin{frame}
    ...
    \par\noindent\rule{\textwidth}{0.4pt}
    \textbf{Intuition}:
    model $\textcolor{RoyalBlue}{\vec U_i}$ via \textcolor{ForestGreen}{healthcare} MTE to identify ADE $+$ AIE.
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}
...
\begin{frame}
    ...
    \par\noindent\rule{\textwidth}{0.4pt}
    \textbf{(3)} Selection on benefits --- unobserved selection in $\textcolor{ForestGreen}{D_i}$ is relevant
    \vfill
    \textbf{Key example:}
...
\begin{frame}
    ...
    \vfill \par\noindent\rule{\textwidth}{0.4pt}
    \textbf{ADE Intuition:}
    Control for unobserved confounding via \textcolor{ForestGreen}{healthcare MTE}.
    
    \vskip0.2cm
    \textbf{AIE Intuition:}
    Extrapolate indirect effects across \textcolor{ForestGreen}{healthcare MTE}.
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}
    ...
    \makebox[\textwidth]{\parbox{1.25\textwidth}{
        \begin{figure}
            \caption{CM Estimates from 10,000 simulated datasets with \textbf{Normal} Errors.}
            \vskip-0.25cm
...
\begin{frame}[noframenumbering]
    ...
    \makebox[\textwidth]{\parbox{1.25\textwidth}{
        \begin{figure}
            \caption{CM Estimates from 10,000 simulated datasets with \textbf{Uniform} Errors.}
            \vskip-0.25cm
            \begin{subfigure}[c]{0.525\textwidth}
                \centering
                \caption{$\hat{\text{ADE}} - \text{ADE}$.}
...
\begin{frame}
    ...
    Winning the wait-list lottery significantly increased healthcare usage, plus subjective well-being (Finkelstein et al, 2012).
    \vskip-0.25cm
    \begin{figure}
        \centering
        \singlespacing
...
\begin{frame}
    ...
    Does using \textcolor{ForestGreen}{healthcare} improve \textcolor{red}{subjective well-being}?
    \vskip-0.5cm
    ...
    \begin{figure}
        ...
        \includegraphics[width=0.5\textwidth]{
            ../text/sections/figures/healthcare-ols-presentation.png}
    \end{figure}
    \begin{itemize}
        \item OLS estimate of $\textcolor{ForestGreen}{\text{healthcare } D_i} \to \textcolor{red}{Y_i \text{ subjective well-being}}$ is $-$2.5pp (1.1).
        \item Controls for initial health conditions gives +2.8pp (1.1).
    \end{itemize}
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}
...
\begin{frame}
    ...
    OLS Estimates had negative or little effects of \textcolor{ForestGreen}{healthcare} $\to$ \textcolor{red}{subjective well-being}.
    \vskip-1cm
    \begin{figure}
        \centering
        \singlespacing
...
\begin{frame}
    ...
    \textbf{Overview:}
    \begin{enumerate}
        \item Selection bias in conventional CM analyses when mediator mechanism strategically selected into.
    ...
    \begin{itemize}
        ...
        \item Application to Oregon Health Insurance Experiment, showing \textcolor{red}{subjective well-being} effects mediated by \textcolor{ForestGreen}{healthcare take-up}
