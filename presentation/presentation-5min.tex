...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Economists stick to vague suggestive evidence, leaving mechanisms relatively under-studied.
    \end{itemize}
...
\begin{frame}
    ...
    \begin{enumerate}
        ...
        \item Meaningful indirect (healthcare) and direct (psychological) effects in Oregon Health Insurance Experiment, with wide confidence intervals.
    \end{enumerate}
    \vfill
    \begin{tabular}{l r}
        Access the paper on my website: &
        \qrcode[height=3cm]{https://https://shoganhennessy.github.io/research}
    \end{tabular}
\end{frame}
%-------------------------------------------------------------------------------
\section{Appendix}
