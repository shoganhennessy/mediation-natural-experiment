...
\begin{frame}[noframenumbering, plain]
    ...
    \begin{center}
        ...
        Applied Young Economists Webinar --- Econ Job Market Vlog \\
        11 November 2025
    \end{center}
\end{frame}
%-------------------------------------------------------------------------------
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Can we assume this causal effect?
    \end{itemize}
\end{frame}
%-------------------------------------------------------------------------------
...
\begin{frame}[noframenumbering]
    ...
    %\vskip-0.35cm
    \begin{itemize}
        \item ADE is causal effect $\textcolor{blue}{Z_i} \to \textcolor{red}{Y_i}$, blocking the indirect $\textcolor{ForestGreen}{D_i}$ path
        \item AIE is causal effect of $\textcolor{ForestGreen}{D_i(Z_i)} \to \textcolor{red}{Y_i}$, blocking the direct $\textcolor{blue}{Z_i}$ path.
    \end{itemize}
    %\[ \text{Average Indirect Effect (AIE):} \;\;\;
    %\E{Y_i\left(Z_i, \eqhighlight{ForestGreen}{D_i(1)} \right)
    %    - Y_i\left(Z_i, \eqhighlight{ForestGreen}{D_i(0)} \right)} \]
...
\begin{frame}
    \frametitle{2. Causal Mediation --- Selection Bias}
    Simulation with cost-benefit selection-into-$\textcolor{ForestGreen}{D_i}$, CM estimates are biased.
...
\begin{frame}
    ...
    \begin{itemize}
        \item Uses an estimate of $\textcolor{ForestGreen}{D_i} \to \textcolor{red}{Y_i}$ with MTE extrapolation
        \item Regular healthcare location pre-lottery serves as first-stage IV \hyperlink{ohie-iv}{\beamergotobutton{IV}}.
        \item MTE estimates of $\textcolor{ForestGreen}{D_i} \to \textcolor{red}{Y_i}$ are larger than OLS \\$\implies$ smaller ADE estimates.
    \end{itemize}
\end{frame}
%-------------------------------------------------------------------------------
\begin{frame}
