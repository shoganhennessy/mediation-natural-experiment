...
\input{../text/sections/tables/oregon-obs-count.txt} people from the wait-list lottery responded to a survey sent by \cite{finkelstein2008oregon} one year later.
