...
\begin{itemize}
    ...
    \item \textit{Mediate} \citep{imai2010causal} automates the sequential-ignorability estimates of CM effects \citep{imai2010identification} in the R language.
\end{itemize}

\begin{figure}[h!]
    \caption{OLS versus Control Function Estimates of CM Effects, Varying $\sigma_1$.}
