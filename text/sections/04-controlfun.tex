...
This gives an average total effect ($Z\to Y$) value of 2.58, ADE 1.44, and AIE ($D(Z) \to Y$) 1.13.\footnote{
...
\begin{figure}[h!]
    ...
    \footnotesize    
    \textbf{Note:}
    These figures show the empirical density of 10,000 bootstrapped point estimates, for the data generating process described above.
