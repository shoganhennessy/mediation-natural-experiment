...
where $\lambda_1 \left(p'\right) = \Egiven{F_V^{-1}\left( U_i \mid \vec{X}_i \right) - \mu_V}{U_i \leq p'}$ for $p' \in (0,1)$.
...
\begin{align*}
    ...
    &\;\;\;\; + \mathbb E \Big[ \bar \pi \; \Egiven{ U_{1,i} - U_{0,i} }{D_i(1) = 1, D_i(0) = 0, \vec{X}_i} \Big] \\
    &= \E{ \bar \pi \, \Bigg(
    ...
    &= \E{ \bar \pi \, \Bigg(
        ...
        + \Egiven{ U_{1,i} - U_{0,i} }{D_i(1) = 1, D_i(0) = 0, \vec{X}_i} \Bigg) } \\
    &= \E{ \bar \pi \; \Egiven{
        \mu_1(Z_i, \vec X_i) - \mu_0(Z_i, \vec X_i) + U_{1,i} - U_{0,i} }{
            D_i(1) = 1, D_i(0) = 0, \vec{X}_i} } \\
    &= \E{ \Egiven{D_i(1) - D_i(0)}{\vec X_i} \; \Egiven{
        Y_i(Z_i, 1) - Y_i(Z_i, 0) }{ D_i(1) = 1, D_i(0) = 0, \vec{X}_i} } \\
