...
The control function approach requires mediator take-up respond only positively to the initial treatment, which implies mediatior selection follows a selection model.
