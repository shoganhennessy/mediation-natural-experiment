...
This means the identifying assumption for conventional CM methods are unlikely to hold, and will lead to biased inference in natural experiment settings, without another research design to isolate random variation in the mediator (at the same time).
