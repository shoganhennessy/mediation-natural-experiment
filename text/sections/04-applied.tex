...
By using the Roy model as a benchmark, I explore the practical limits of the mediator quasi-random assignment assumption.
...
%\footnote{
%    In a similar sense, \cite{huber2024testing} give a method to  test the implications of sequential quasi-random assignment (requiring an instrument).
%}
