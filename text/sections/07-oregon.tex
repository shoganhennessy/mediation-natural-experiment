...
\begin{figure}[h!]
    ...
    The shaded region refers to the AIE, where the average causal effect is calculated across the region of mediator compliers, with $\pi(0; \vec X_i) \leq U_u < \pi(1; \vec X_i)$ --- i.e., between 0.715 and 0.750, at the average covariate values.
\end{figure}
