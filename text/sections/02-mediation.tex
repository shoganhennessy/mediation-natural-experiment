...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \node[color=orange] [below left=-0.3cm and 0.15cm of mediator] {First-stage};
        \node[color=orange] [below right=-0.3cm and 0.75cm of mediator] {Compliers' AIE};
        \node[color=orange] [below=1cm of mediator] {ADE};
    ...
    Compliers' AIE refers to the AIE local to $D_i(Z_i)$ compliers, so that AIE $=$ average first-stage $\times$ compliers' AIE.
