...
Write $K_i$ for the expected values in predicting the mediator with observed controls $\vec X_i$.
...
Assumption \ref{dfn:controlfun-assumptions}\eqref{eqn:controlfun-ident} is the control function, which is assuming that first-stage unobserved heterogeneity explains second-stage selection into $D_i$.
