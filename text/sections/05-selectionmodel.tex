...
This restricted support assumption is weaker than relying on identification at infinity, with testable implications.
See \aref{appendix:mte-restricted}.
...
\begin{theoremMTE}
    ...
    If assumptions \ref{mte:monotonicity}, \ref{mte:identification}, \ref{mte:instrument}, and the restricted-CF support condition hold, the ADE and AIE are identified as a function of the parameters in Proposition \ref{proposition:secondstage}.
    \begin{align*}
    \text{ADE}
