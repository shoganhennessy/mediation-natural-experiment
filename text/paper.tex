...
\date{
    ...
    %newest version
    %\href{https://github.com/shoganhennessy/mediation-natural-experiment}{available here}.}}
    \vspace{-1.0cm}
}
\rhead{\today}
...
\input{sections/03-selection.tex}
% Discussion Section
\input{sections/04-controlfun.tex}
% Conclusion Section
...
\bibliography{sections/06-bibliography.bib}
%\bibliography{sections/06-bibliography-doi.bib}
% Appendix
\newpage
