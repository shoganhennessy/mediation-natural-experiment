## Sourced from https://rdrr.io/github/CarrThomas/TestforInstrumentValidity/
## WHich is now offline, so preserved here as of 12 April 2024, by Senan Hogan-Hennessy.
